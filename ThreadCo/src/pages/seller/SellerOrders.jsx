...
const STATUS_PILLS = [
  { status: 'Processing', Icon: Clock, iconColor: '#f59e0b' },
  { status: 'Shipped', Icon: Truck, iconColor: '#3b82f6' },
  { status: 'Delivered', Icon: CheckCircle, iconColor: '#10b981' },
  { status: 'Cancelled', Icon: XCircle, iconColor: '#ef4444' },
]
    ...
    <div className="seller-orders-page">
      <div className="container">
        ...
        <div className="order-summary-pills">
          {STATUS_PILLS.map(({ status, Icon, iconColor }) => (
            <div key={status} className="order-pill">
            ...
            <table className="sp-table">
              <thead>
                <tr>
                  ...
                  <th>Size</th><th>Date</th><th>Amount</th><th>Status</th><th>Action</th>
                </tr>
              </thead>
              <tbody>
                {filtered.map(o => (
