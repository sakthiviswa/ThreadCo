...
import { Wallet, Clock, TrendingUp, Landmark, ArrowDownToLine } from 'lucide-react'
        ...
        <div className="payments-layout">
          <div className="payments-main">
            ...
            <div className="wallet-card">
              <div className="wallet-item">
                <span className="wallet-label" style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <div className="card">
              ...
              <table className="sp-table">
                <thead>
                  <tr>
                    <th>Payout ID</th><th>Period</th><th>Orders</th>
                    <th>Gross Revenue</th><th>Platform Fee (5%)</th>
                    <th>Net Settled</th><th>Status</th><th>Paid On</th>
                  </tr>
                </thead>
                <tbody>
                  {PAYOUTS.map(p => (
          ...
          <div className="payments-sidebar">
            ...
            <div className="card" style={{ padding: 22 }}>
              <h3 style={{ fontFamily: 'var(--font-head)', fontSize: 17, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
